...
{{--                        <div class="pl-3 ml-3 pt-2" style="border-left:1px solid rgba(0, 0, 0, 0.5); font-size:1.5rem;">{{ config('app.name', 'Laravel') }}</div>--}}
                        <div class="pl-3 ml-3 pt-2" style="border-left:1px solid rgba(0, 0, 0, 0.5); font-size:1.5rem;">Oracle Store</div>
            ...
            <div class='container p-0 pt-3'>
                <div class='row'>
                    <div class='col-md-4 col-sm-12 pt-3'>
                        ...
                        <p>Oracle Store <br> 280 An Duong Vuong. P4. Q5 <br> +843456789 <br> customercare@oraclestore.com</p>
                    </div>
                    <div class='col-md-4 col-sm-12 pt-3'>
                        <h3>Follow Us On</h3>
                        <ul>
                    ...
                    <div class='col-md-6 col-sm-12 copyright'>
                        <p>Final Report to CDO - Oracle</p>
                        <p>Oracle Store &copy; 2022. All Rights Reserved</p>
                    </div>
